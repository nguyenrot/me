    ...
    <section id="about" className="relative px-4 py-24 sm:px-8 sm:py-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          >
            <div className="space-y-6 text-base leading-8 text-[rgba(200,216,255,0.82)] sm:text-lg">
              <p>
            ...
            {/* Quote */}
            <div className="relative mt-8 border-l-[3px] border-[rgba(255,215,0,0.4)] pl-6">
